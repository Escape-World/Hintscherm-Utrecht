...
read -p "Enter the URL to display on HDMI-1 in kiosk mode: " kiosk_url_1
read -p "Enter the URL to display on HDMI-2 in kiosk mode: " kiosk_url_2
...
# Create and configure autostart script to manage two displays
...
# Start Chromium on HDMI-1 in kiosk mode
export DISPLAY=:0
chromium-browser --noerrdialogs --disable-infobars --kiosk $kiosk_url_1 --window-position=0,0 --window-size=1920,1080 &

# Start Chromium on HDMI-2 in kiosk mode
export DISPLAY=:0
chromium-browser --noerrdialogs --disable-infobars --kiosk $kiosk_url_2 --window-position=1920,0 --window-size=1920,1080 &
EOL
